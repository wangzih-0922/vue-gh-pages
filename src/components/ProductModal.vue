            ...
            <div class="col-sm-4">
              <div class="mb-2">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control mt-2" id="imageUrl" placeholder="請輸入圖片連結" v-model="tempProduct.imageUrl">
...
export default {
  ...
  watch: {
    itemProduct () {
      this.tempProduct = this.itemProduct
    }
  },
  methods: {
    openModal () {
